...
<head>
    ...
    <title>Login - Boleibol Federazioa</title>
</head>
...
<body>
        ...
        <nav>
            <ul>
                ...
                <?php if (isset($_SESSION["rolUsuario"]) && $_SESSION["rolUsuario"] == "epaile"): ?>
                    <li><a href="epaile_partidak.php">Partiduak ikusi</a></li>
                <?php endif; ?>
    ...
    <main>
        ...
        <section class="login">
            <!-- Logineko diseinua "Uiverse.io" -etik dator -->
            <form action="login.php" method="POST" class="form">
                ...
                <p class="itxi">
                    <?php
                    if (isset($_GET['itxi'])) {
                        echo 'Saioa behar bezala itxi da.';
                    }
                    ?>
                </p>
                <br>
                ...
                <div class="input-container">
                    <label for="" class="user_pass">Erabiltzailea:</label>
                    <input class="erab" type="text" name="erabiltzailea" required>
                    <!-- required de que si o si hay que rellenarlo -->
                    <span> </span>
                </div>
                <br>
                ...
                <div class="input-container">
                    <label for="" class="user_pass">Pasahitza: </label>
                    <input type="password" name="pasahitza" required>
                    <!-- en el type poner "password "para que al escribir no salga lo que escribes-->

                </div>
                <br>
                <input class="submit" type="submit" value="Sartu">
                <!-- <p class="signup-link">
                    No account?
